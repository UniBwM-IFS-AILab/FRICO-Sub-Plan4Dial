...
def generate_files(yaml_filename: str, output_folder: str, rbp_path: str):
    ...
    subprocess.run(["sudo",rbp_path, domain_str, problem_str, "--output-format", "3"])
...
if __name__ == "__main__":
    ...
    dirname = f"/home/qnc/Plan4Dial/plan4dial/plan4dial/local_data/conversation_alignment_bots/{bot_name}"
    generate_files(
        f"{dirname}/{bot_name}.yml",
        f"{dirname}/output_files",
        "/home/qnc/Plan4Dial/plan4dial/rbp.sif",
    )
    print("Completed")
